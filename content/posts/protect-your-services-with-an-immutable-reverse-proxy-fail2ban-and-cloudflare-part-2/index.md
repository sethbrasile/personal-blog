  ...
  units:
    ...
    - name: proxy.service
      ...
      contents: |
        ...
        # IF you use LetsEncrypt instead of zerossl, the value for STAGING is set to `true` initially, while you're ensuring your config is correct.
        # This avoids running into any API limits and etc..
        ...
        # If you leave this on zerossl, it doesn't matter
